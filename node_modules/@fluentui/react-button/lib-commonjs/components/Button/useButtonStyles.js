...
const useButtonStyles_unstable = state => {
  ...
  state.root.className = react_1.mergeClasses(exports.buttonClassNames.root, // Root styles
  ...
  if (state.icon) {
    state.icon.className = react_1.mergeClasses(exports.buttonClassNames.icon, iconStyles.base, state.root.children !== undefined && state.root.children !== null && iconStyles[iconPosition], appearance === 'subtle' && iconStyles.subtle, iconStyles[size], state.icon.className);
  }
