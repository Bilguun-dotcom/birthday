...
declare type FindFirstProps = Pick<FindFocusableProps, "container" | "includeProgrammaticallyFocusable" | "ignoreUncontrolled" | "ignoreAccessibiliy">;
declare type FindNextProps = Pick<FindFocusableProps, "currentElement" | "container" | "includeProgrammaticallyFocusable" | "ignoreUncontrolled" | "ignoreAccessibiliy" | "onUncontrolled">;
declare type FindDefaultProps = Pick<FindFocusableProps, "container" | "includeProgrammaticallyFocusable" | "ignoreAccessibiliy">;
declare type FindAllProps = Pick<FindFocusableProps, "container" | "currentElement" | "isBackward" | "includeProgrammaticallyFocusable" | "acceptCondition" | "ignoreUncontrolled" | "ignoreAccessibiliy" | "onElement"> & {
    container: HTMLElement;
};
/**
...
export { Types_d as Types, createTabster, disposeTabster, forceCleanup, getCrossOrigin, getDeloser, getGroupper, getInternal, getModalizer, getMover, getObservedElement, getOutline, getTabster, getTabsterAttribute, isNoOp, makeNoOp, setTabsterAttribute };
