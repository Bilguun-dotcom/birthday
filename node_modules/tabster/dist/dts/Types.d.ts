...
export declare type GetTabster = () => TabsterCore;
export declare type GetWindow = () => Window;
export declare type SubscribableCallback<A, B = undefined> = (val: A, details: B) => void;
...
export declare type CrossOriginTransactionType = CrossOriginTransactionTypes[keyof CrossOriginTransactionTypes];
...
export declare type CrossOriginTransactionSend = (data: CrossOriginTransactionData<any, any>) => void;
...
export declare type RestoreFocusOrder = RestoreFocusOrders[keyof RestoreFocusOrders];
...
export declare type DeloserConstructor = (element: HTMLElement, props: DeloserProps) => Deloser;
...
export declare type FindFirstProps = Pick<FindFocusableProps, "container" | "includeProgrammaticallyFocusable" | "ignoreUncontrolled" | "ignoreAccessibiliy">;
export declare type FindNextProps = Pick<FindFocusableProps, "currentElement" | "container" | "includeProgrammaticallyFocusable" | "ignoreUncontrolled" | "ignoreAccessibiliy" | "onUncontrolled">;
export declare type FindDefaultProps = Pick<FindFocusableProps, "container" | "includeProgrammaticallyFocusable" | "ignoreAccessibiliy">;
export declare type FindAllProps = Pick<FindFocusableProps, "container" | "currentElement" | "isBackward" | "includeProgrammaticallyFocusable" | "acceptCondition" | "ignoreUncontrolled" | "ignoreAccessibiliy" | "onElement"> & {
    container: HTMLElement;
};
/**
 * A callback that is called for every found element during search. Returning false stops search.
 */
export declare type FindElementCallback = (element: HTMLElement) => boolean;
...
export declare type Visibility = Visibilities[keyof Visibilities];
...
export declare type MoverDirection = MoverDirections[keyof MoverDirections];
export declare type NextTabbable = {
...
export declare type MoverEvent = TabsterEventWithDetails<MoverElementState>;
...
export declare type MoverConstructor = (tabster: TabsterCore, element: HTMLElement, props: MoverProps) => Mover;
...
export declare type GroupperTabbability = GroupperTabbabilities[keyof GroupperTabbabilities];
...
export declare type GroupperConstructor = (tabster: TabsterCore, element: HTMLElement, props: GroupperProps) => Groupper;
...
export declare type ModalizerEventDetails = {
    eventName: "beforefocusout";
};
export declare type ModalizerEvent = TabsterEventWithDetails<ModalizerEventDetails>;
...
export declare type ModalizerConstructor = (tabster: TabsterCore, element: HTMLElement, props: ModalizerProps) => Modalizer;
...
export declare type RootConstructor = (tabster: TabsterCore, element: HTMLElement, props: RootProps) => Root;
...
export declare type TabsterContextMoverGroupper = {
    isMover: true;
    mover: Mover;
} | {
    isMover: false;
...
export declare type TabsterAttributeProps = Partial<{
...
export declare type TabsterOnElement = Partial<RootOnElement & DeloserOnElement & ModalizerOnElement & FocusableOnElement & MoverOnElement & GroupperOnElement & ObservedOnElement & OutlineOnElement & UncontrolledOnElement>;
